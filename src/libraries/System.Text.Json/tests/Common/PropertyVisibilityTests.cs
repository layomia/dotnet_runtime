...
namespace System.Text.Json.Serialization.Tests
{
    public abstract partial class PropertyVisibilityTests : SerializerTests
    {
        ...
        [Fact]
        public void Serialize_NewSlotPublicField()
        {
            // Serialize
            var obj = new ClassWithNewSlotField();
            string json = JsonSerializerWrapper.Serialize(obj);

            Assert.Equal(@"{""MyString"":""NewDefaultValue""}", json);

            // Deserialize
            json = @"{""MyString"":""NewValue""}";
            obj = JsonSerializerWrapper.Deserialize<ClassWithNewSlotField>(json);
        ...
        [Fact]
        public void Serialize_NewSlotPublicProperty()
        {
            // Serialize
            ...
            // Deserialize
            json = @"{""MyString"":""NewValue""}";
            obj = JsonSerializerWrapper.Deserialize<ClassWithNewSlotProperty>(json);
        ...
        [Fact]
        public void Serialize_BasePublicProperty_ConflictWithDerivedPrivate()
        {
            // Serialize
            ...
            // Deserialize
            json = @"{""MyString"":""NewValue""}";
            obj = JsonSerializerWrapper.Deserialize<ClassWithNewSlotInternalProperty>(json);
        ...
        [Fact]
        public void Serialize_PublicProperty_ConflictWithPrivateDueAttributes()
        {
            // Serialize
            ...
            // Newtonsoft.Json throws JsonSerializationException here because
            // non-public properties are included when [JsonProperty] is placed on them.
            obj = JsonSerializerWrapper.Deserialize<ClassWithPropertyNamingConflict>(json);
        ...
        [Fact]
        public void Serialize_PublicProperty_ConflictWithPrivateDuePolicy()
        {
            var options = new JsonSerializerOptions { PropertyNamingPolicy = JsonNamingPolicy.CamelCase };

            // Serialize
            var obj = new ClassWithPropertyPolicyConflict();
            string json = JsonSerializerWrapper.Serialize(obj, options);

            Assert.Equal(@"{""myString"":""DefaultValue""}", json);

            // Deserialize
            json = @"{""myString"":""NewValue""}";
            obj = JsonSerializerWrapper.Deserialize<ClassWithPropertyPolicyConflict>(json, options);
        ...
        [Fact]
        public void Serialize_NewSlotPublicProperty_ConflictWithBasePublicProperty()
        {
            // Serialize
            ...
            // Deserialize
            json = @"{""MyNumeric"":2.5}";
            obj = JsonSerializerWrapper.Deserialize<ClassWithNewSlotDecimalProperty>(json);

            Assert.Equal(2.5M, obj.MyNumeric);
        }

        [Fact]
        public void Serialize_NewSlotPublicField_ConflictWithBasePublicProperty()
        {
            // Serialize
            ...
            // Deserialize
            json = @"{""MyNumeric"":2.5}";
            obj = JsonSerializerWrapper.Deserialize<ClassWithNewSlotDecimalField>(json);

            Assert.Equal(2.5M, obj.MyNumeric);
        }

        [Fact]
        public void Serialize_NewSlotPublicField_SpecifiedJsonPropertyName()
        {
            // Serialize
            ...
            obj = JsonSerializerWrapper.Deserialize<ClassWithNewSlotAttributedDecimalField>(json);
        ...
        [Fact]
        public void Serialize_NewSlotPublicProperty_SpecifiedJsonPropertyName()
        {
            // Serialize
            ...
            // Deserialize
            json = @"{""MyNewNumeric"":2.5,""MyNumeric"":4}";
            obj = JsonSerializerWrapper.Deserialize<ClassWithNewSlotAttributedDecimalProperty>(json);
        ...
        [Fact]
        public void Ignore_NonPublicProperty()
        {
            // Serialize
            ...
            // Deserialize
            json = @"{""MyString"":""NewValue""}";
            obj = JsonSerializerWrapper.Deserialize<ClassWithInternalProperty>(json);

            Assert.Equal("DefaultValue", obj.MyString);
        }

        [Fact]
        public void Ignore_NewSlotPublicFieldIgnored()
        {
            // Serialize
            ...
            // Deserialize
            json = @"{""MyString"":""NewValue""}";
            obj = JsonSerializerWrapper.Deserialize<ClassWithIgnoredNewSlotField>(json);
        ...
        [Fact]
        public void Ignore_NewSlotPublicPropertyIgnored()
        {
            // Serialize
            ...
            // Deserialize
            json = @"{""MyString"":""NewValue""}";
            obj = JsonSerializerWrapper.Deserialize<ClassWithIgnoredNewSlotProperty>(json);
        ...
        [Fact]
        public void Ignore_BasePublicPropertyIgnored_ConflictWithDerivedPrivate()
        {
            // Serialize
            ...
            // Deserialize
            json = @"{""MyString"":""NewValue""}";
            obj = JsonSerializerWrapper.Deserialize<ClassWithIgnoredPublicPropertyAndNewSlotPrivate>(json);
        ...
        [Fact]
        public void Ignore_PublicProperty_ConflictWithPrivateDueAttributes()
        {
            // Serialize
            ...
            // Deserialize
            json = @"{""MyString"":""NewValue""}";
            obj = JsonSerializerWrapper.Deserialize<ClassWithIgnoredPropertyNamingConflictPrivate>(json);
        ...
        [Fact]
        public void Ignore_PublicProperty_ConflictWithPrivateDuePolicy()
        {
            var options = new JsonSerializerOptions { PropertyNamingPolicy = JsonNamingPolicy.CamelCase };
            ...
            // Deserialize
            json = @"{""myString"":""NewValue""}";
            obj = JsonSerializerWrapper.Deserialize<ClassWithIgnoredPropertyPolicyConflictPrivate>(json, options);
        ...
        [Fact]
        public void Ignore_PublicProperty_ConflictWithPublicDueAttributes()
        {
            // Serialize
            ...
            // Deserialize
            json = @"{""MyString"":""NewValue""}";
            obj = JsonSerializerWrapper.Deserialize<ClassWithIgnoredPropertyNamingConflictPublic>(json);
        ...
        [Fact]
        public void Ignore_PublicProperty_ConflictWithPublicDuePolicy()
        {
            var options = new JsonSerializerOptions { PropertyNamingPolicy = JsonNamingPolicy.CamelCase };
            ...
            // Deserialize
            json = @"{""myString"":""NewValue""}";
            obj = JsonSerializerWrapper.Deserialize<ClassWithIgnoredPropertyPolicyConflictPublic>(json, options);
        ...
        [Fact]
        public void Throw_PublicProperty_ConflictDueAttributes()
        {
            // Serialize
            var obj = new ClassWithPropertyNamingConflictWhichThrows();
            Assert.Throws<InvalidOperationException>(
                () => JsonSerializerWrapper.Serialize(obj));

            // Deserialize
            string json = @"{""MyString"":""NewValue""}";
            Assert.Throws<InvalidOperationException>(
                () => JsonSerializerWrapper.Deserialize<ClassWithPropertyNamingConflictWhichThrows>(json));
        }

        [Fact]
        public void Throw_PublicPropertyAndField_ConflictDueAttributes()
        {
            // Serialize
            ...
            string json = @"{""MyString"":""NewValue""}";
            Assert.Throws<InvalidOperationException>(
                () => JsonSerializerWrapper.Deserialize<ClassWithPropertyFieldNamingConflictWhichThrows>(json));
        }

        [Fact]
        public void Throw_PublicProperty_ConflictDueAttributes_SingleInheritance()
        {
            // Serialize
            ...
            string json = @"{""MyString"":""NewValue""}";
            Assert.Throws<InvalidOperationException>(
                () => JsonSerializerWrapper.Deserialize<ClassInheritedWithPropertyNamingConflictWhichThrows>(json));
        ...
        [Fact]
        public void Throw_PublicPropertyAndField_ConflictDueAttributes_SingleInheritance()
        {
            // Serialize
            ...
            string json = @"{""MyString"":""NewValue""}";
            Assert.Throws<InvalidOperationException>(
                () => JsonSerializerWrapper.Deserialize<ClassInheritedWithPropertyFieldNamingConflictWhichThrows>(json));
        ...
        [Fact]
        public void Throw_PublicProperty_ConflictDueAttributes_DoubleInheritance()
        {
            // Serialize
            ...
            Assert.Throws<InvalidOperationException>(
                () => JsonSerializerWrapper.Deserialize<ClassTwiceInheritedWithPropertyNamingConflictWhichThrows>(json));
        ...
        [Fact]
        public void Throw_PublicPropertyAndField_ConflictDueAttributes_DoubleInheritance()
        {
            // Serialize
            ...
            Assert.Throws<InvalidOperationException>(
                () => JsonSerializerWrapper.Deserialize<ClassTwiceInheritedWithPropertyFieldNamingConflictWhichThrows>(json));
        ...
        [Fact]
        public void Throw_PublicProperty_ConflictDuePolicy()
        {
            var options = new JsonSerializerOptions { PropertyNamingPolicy = JsonNamingPolicy.CamelCase };
            ...
            Assert.Throws<InvalidOperationException>(
                () => JsonSerializerWrapper.Serialize(obj, options));

            // Deserialize
            string json = @"{""MyString"":""NewValue""}";
            Assert.Throws<InvalidOperationException>(
                () => JsonSerializerWrapper.Deserialize<ClassWithPropertyPolicyConflictWhichThrows>(json, options));
        }

        [Fact]
        public void Throw_PublicPropertyAndField_ConflictDuePolicy()
        {
            var options = new JsonSerializerOptions { PropertyNamingPolicy = JsonNamingPolicy.CamelCase };
            ...
            string json = @"{""MyString"":""NewValue""}";
            Assert.Throws<InvalidOperationException>(
                () => JsonSerializerWrapper.Deserialize<ClassWithPropertyFieldPolicyConflictWhichThrows>(json, options));
        }

        [Fact]
        public void Throw_PublicProperty_ConflictDuePolicy_SingleInheritance()
        {
            var options = new JsonSerializerOptions { PropertyNamingPolicy = JsonNamingPolicy.CamelCase };
            ...
            string json = @"{""MyString"":""NewValue""}";
            Assert.Throws<InvalidOperationException>(
                () => JsonSerializerWrapper.Deserialize<ClassInheritedWithPropertyPolicyConflictWhichThrows>(json, options));
        ...
        [Fact]
        public void Throw_PublicPropertyAndField_ConflictDuePolicy_SingleInheritance()
        {
            var options = new JsonSerializerOptions { PropertyNamingPolicy = JsonNamingPolicy.CamelCase };
            ...
            string json = @"{""MyString"":""NewValue""}";
            Assert.Throws<InvalidOperationException>(
                () => JsonSerializerWrapper.Deserialize<ClassInheritedWithPropertyFieldPolicyConflictWhichThrows>(json, options));
        ...
        [Fact]
        public void Throw_PublicProperty_ConflictDuePolicy_DobuleInheritance()
        {
            var options = new JsonSerializerOptions { PropertyNamingPolicy = JsonNamingPolicy.CamelCase };
            ...
            Assert.Throws<InvalidOperationException>(
                () => JsonSerializerWrapper.Deserialize<ClassTwiceInheritedWithPropertyPolicyConflictWhichThrows>(json, options));
        ...
        [Fact]
        public void Throw_PublicPropertyAndField_ConflictDuePolicy_DobuleInheritance()
        {
            var options = new JsonSerializerOptions { PropertyNamingPolicy = JsonNamingPolicy.CamelCase };
            ...
            Assert.Throws<InvalidOperationException>(
                () => JsonSerializerWrapper.Deserialize<ClassTwiceInheritedWithPropertyFieldPolicyConflictWhichThrows>(json, options));
        ...
        [Fact]
        public void HiddenPropertiesIgnored_WhenOverridesIgnored()
        {
            string serialized = JsonSerializerWrapper.Serialize(new DerivedClass_With_IgnoredOverride());
            Assert.Equal(@"{}", serialized);

            serialized = JsonSerializerWrapper.Serialize(new DerivedClass_WithVisibleProperty_Of_DerivedClass_With_IgnoredOverride());
            Assert.Equal(@"{""MyProp"":false}", serialized);

            serialized = JsonSerializerWrapper.Serialize(new DerivedClass_With_IgnoredOverride_And_ConflictingPropertyName());
            Assert.Equal(@"{""MyProp"":null}", serialized);

            serialized = JsonSerializerWrapper.Serialize(new DerivedClass_With_Ignored_NewProperty());
            Assert.Equal(@"{""MyProp"":false}", serialized);

            serialized = JsonSerializerWrapper.Serialize(new DerivedClass_WithConflictingNewMember());
            Assert.Equal(@"{""MyProp"":false}", serialized);

            serialized = JsonSerializerWrapper.Serialize(new DerivedClass_WithConflictingNewMember_Of_DifferentType());
            Assert.Equal(@"{""MyProp"":0}", serialized);

            serialized = JsonSerializerWrapper.Serialize(new DerivedClass_With_Ignored_ConflictingNewMember());
            Assert.Equal(@"{""MyProp"":false}", serialized);

            serialized = JsonSerializerWrapper.Serialize(new DerivedClass_With_Ignored_ConflictingNewMember_Of_DifferentType());
            Assert.Equal(@"{""MyProp"":false}", serialized);

            serialized = JsonSerializerWrapper.Serialize(new DerivedClass_With_NewProperty_And_ConflictingPropertyName());
            Assert.Equal(@"{""MyProp"":null}", serialized);

            serialized = JsonSerializerWrapper.Serialize(new DerivedClass_With_Ignored_NewProperty_Of_DifferentType());
            Assert.Equal(@"{""MyProp"":false}", serialized);

            serialized = JsonSerializerWrapper.Serialize(new DerivedClass_With_Ignored_NewProperty_Of_DifferentType_And_ConflictingPropertyName());
            Assert.Equal(@"{""MyProp"":null}", serialized);

            serialized = JsonSerializerWrapper.Serialize(new FurtherDerivedClass_With_ConflictingPropertyName());
            Assert.Equal(@"{""MyProp"":null}", serialized);
            ...
            Assert.Throws<InvalidOperationException>(() => JsonSerializerWrapper.Serialize(new DerivedClass_WithConflictingPropertyName()));

            serialized = JsonSerializerWrapper.Serialize(new FurtherDerivedClass_With_IgnoredOverride());
            Assert.Equal(@"{""MyProp"":null}", serialized);
        }
        ...
        [Fact]
        public void IgnoreReadOnlyProperties()
        {
        ...
        public void NoSetter()
        {
            ...
            obj = JsonSerializerWrapper.Deserialize<ClassWithNoSetter>(@"{""MyString"":""IgnoreMe"",""MyInts"":[0]}");
            Assert.Equal("DefaultValue", obj.MyString);
        ...
        {
            ClassWithNoGetter objWithNoGetter = JsonSerializerWrapper.Deserialize<ClassWithNoGetter>(
        ...
        public void PrivateSetter()
        {
            ...
            ClassWithPrivateSetterAndGetter objCopy = JsonSerializerWrapper.Deserialize<ClassWithPrivateSetterAndGetter>(json);
            Assert.Null(objCopy.GetMyString());
        }

        [Fact]
        public void PrivateSetterPublicGetter()
        {
            // https://github.com/dotnet/runtime/issues/29503
            ClassWithPublicGetterAndPrivateSetter obj
                = JsonSerializerWrapper.Deserialize<ClassWithPublicGetterAndPrivateSetter>(@"{ ""Class"": {} }");
        ...
        [Fact]
        public void MissingObjectProperty()
        {
            ClassWithMissingObjectProperty obj
                = JsonSerializerWrapper.Deserialize<ClassWithMissingObjectProperty>(@"{ ""Object"": {} }");

            Assert.Null(obj.Collection);
        }

        [Fact]
        public void MissingCollectionProperty()
        {
            ClassWithMissingCollectionProperty obj
                = JsonSerializerWrapper.Deserialize<ClassWithMissingCollectionProperty>(@"{ ""Collection"": [] }");
        ...
        [Fact]
        public void JsonIgnoreAttribute()
        {
            ...
            obj = JsonSerializerWrapper.Deserialize<ClassWithIgnoreAttributeProperty>(@"{}", options);
            Assert.Equal(@"MyString", obj.MyString);
            Assert.Equal(@"MyStringWithIgnore", obj.MyStringWithIgnore);
            Assert.Equal(2, obj.MyStringsWithIgnore.Length);
            Assert.Equal(1, obj.MyDictionaryWithIgnore["Key"]);
            ...
            obj = JsonSerializerWrapper.Deserialize<ClassWithIgnoreAttributeProperty>(
        ...
        [Fact]
        public void JsonIgnoreAttribute_UnsupportedCollection()
        {
            string json =
                    @"{
                        ""MyConcurrentDict"":{
            ...
            Assert.Throws<NotSupportedException>(() => JsonSerializerWrapper.Deserialize<ClassWithUnsupportedDictionary>(json));
            ...
            Assert.Throws<NotSupportedException>(() => JsonSerializerWrapper.Serialize(instance, options));

            // Unsupported collections will throw on deserialize by default if they contain elements.
            options = new JsonSerializerOptions();
            Assert.Throws<NotSupportedException>(() => JsonSerializerWrapper.Deserialize<WrapperForClassWithUnsupportedDictionary>(wrapperJson, options));
            ...
            Assert.NotNull(JsonSerializerWrapper.Serialize(instanceWithIgnore, options));

            ClassWithIgnoredUnsupportedDictionary obj = JsonSerializerWrapper.Deserialize<ClassWithIgnoredUnsupportedDictionary>(json, options);
            Assert.Null(obj.MyDict);

            options = new JsonSerializerOptions();
            Assert.Equal("{}", JsonSerializerWrapper.Serialize(new ClassWithIgnoredUnsupportedDictionary()));

            options = new JsonSerializerOptions();
            WrapperForClassWithIgnoredUnsupportedDictionary wrapperObj = JsonSerializerWrapper.Deserialize<WrapperForClassWithIgnoredUnsupportedDictionary>(wrapperJson, options);
            Assert.Null(wrapperObj.MyClass.MyDict);

            options = new JsonSerializerOptions();
            Assert.Equal(@"{""MyClass"":{}}", JsonSerializerWrapper.Serialize(new WrapperForClassWithIgnoredUnsupportedDictionary()
            {
        ...
        [Fact]
        public void JsonIgnoreAttribute_UnsupportedBigInteger()
        {
            string json = @"{""MyBigInteger"":1}";
            string wrapperJson = @"{""MyClass"":{""MyBigInteger"":1}}";

            // Unsupported types will throw by default.
            Assert.Throws<JsonException>(() => JsonSerializerWrapper.Deserialize<ClassWithUnsupportedBigInteger>(json));
            // Using new options instance to prevent using previously cached metadata.
            JsonSerializerOptions options = new JsonSerializerOptions();
            Assert.Throws<JsonException>(() => JsonSerializerWrapper.Deserialize<WrapperForClassWithUnsupportedBigInteger>(wrapperJson, options));

            // When ignored, we can serialize and deserialize without exceptions.
            options = new JsonSerializerOptions();
            ClassWithIgnoredUnsupportedBigInteger obj = JsonSerializerWrapper.Deserialize<ClassWithIgnoredUnsupportedBigInteger>(json, options);
            Assert.Null(obj.MyBigInteger);

            options = new JsonSerializerOptions();
            Assert.Equal("{}", JsonSerializerWrapper.Serialize(new ClassWithIgnoredUnsupportedBigInteger()));

            options = new JsonSerializerOptions();
            WrapperForClassWithIgnoredUnsupportedBigInteger wrapperObj = JsonSerializerWrapper.Deserialize<WrapperForClassWithIgnoredUnsupportedBigInteger>(wrapperJson, options);
            Assert.Null(wrapperObj.MyClass.MyBigInteger);

            options = new JsonSerializerOptions();
            Assert.Equal(@"{""MyClass"":{}}", JsonSerializerWrapper.Serialize(new WrapperForClassWithIgnoredUnsupportedBigInteger()
            {
        ...
        [Fact]
        public void OverrideJsonIgnorePropertyUsingJsonPropertyName()
        {
            const string json = @"{""EnumValue"":""Case2""}";

            StructWithOverride obj = JsonSerializerWrapper.Deserialize<StructWithOverride>(json);

            Assert.Equal(MyEnum.Case2, obj.EnumValue);
            Assert.Equal("Case2", obj.EnumString);

            string jsonSerialized = JsonSerializerWrapper.Serialize(obj);
        ...
        [Fact]
        public void OverrideJsonIgnorePropertyUsingJsonPropertyNameReversed()
        {
            const string json = @"{""EnumValue"":""Case2""}";

            ClassWithOverrideReversed obj = JsonSerializerWrapper.Deserialize<ClassWithOverrideReversed>(json);
        ...
        public void JsonIgnoreConditionSetToAlwaysWorks(Type type)
        {
            string json = @"{""MyString"":""Random"",""MyDateTime"":""2020-03-23"",""MyInt"":4}";

            object obj = JsonSerializerWrapper.Deserialize(json, type);
            ...
            string serialized = JsonSerializerWrapper.Serialize(obj);
        ...
        public void JsonIgnoreConditionWhenWritingDefault_ClassProperty(Type type, JsonSerializerOptions options)
        {
            // Property shouldn't be ignored if it isn't null.
            string json = @"{""Int1"":1,""MyString"":""Random"",""Int2"":2}";

            object obj = JsonSerializerWrapper.Deserialize(json, type, options);
            Assert.Equal(1, (int)type.GetProperty("Int1").GetValue(obj));
            Assert.Equal("Random", (string)type.GetProperty("MyString").GetValue(obj));
            Assert.Equal(2, (int)type.GetProperty("Int2").GetValue(obj));

            string serialized = JsonSerializerWrapper.Serialize(obj, options);
            ...
            obj = JsonSerializerWrapper.Deserialize(json, type, options);
            Assert.Equal(1, (int)type.GetProperty("Int1").GetValue(obj));
            ...
            serialized = JsonSerializerWrapper.Serialize(obj, options);
            Assert.Contains(@"""Int1"":1", serialized);
            Assert.Contains(@"""Int2"":2", serialized);
        ...
        public void JsonIgnoreConditionWhenWritingDefault_StructProperty(Type type, JsonSerializerOptions options)
        {
            // Property shouldn't be ignored if it isn't null.
            ...
            Assert.Throws<JsonException>(() => JsonSerializerWrapper.Deserialize(json, type, options));
        }
        ...
        public void JsonIgnoreConditionNever(Type type)
        {
            ...
            obj = JsonSerializerWrapper.Deserialize(json, type);
            Assert.Equal(1, (int)type.GetProperty("Int1").GetValue(obj));
            Assert.Null((string)type.GetProperty("MyString").GetValue(obj));
            Assert.Equal(2, (int)type.GetProperty("Int2").GetValue(obj));

            serialized = JsonSerializerWrapper.Serialize(obj);
            Assert.Contains(@"""Int1"":1", serialized);
        ...
        [Theory]
        [MemberData(nameof(JsonIgnoreConditionNever_TestData))]
        public void JsonIgnoreConditionNever_IgnoreNullValues_True(Type type)
        {
        ...
        [Fact]
        public void JsonIgnoreCondition_LastOneWins()
        {
            ...
            var obj = JsonSerializerWrapper.Deserialize<ClassWithStructProperty_IgnoreConditionNever>(json, options);

            Assert.Null(obj.MyString);
        }

        [Fact]
        public void ClassWithComplexObjectsUsingIgnoreWhenWritingDefaultAttribute()
        {
            string json = @"{""Class"":{""MyInt16"":18}, ""Dictionary"":null}";

            ClassUsingIgnoreWhenWritingDefaultAttribute obj = JsonSerializerWrapper.Deserialize<ClassUsingIgnoreWhenWritingDefaultAttribute>(json);
            ...
            json = JsonSerializerWrapper.Serialize(obj);
        ...
        public void ClassWithComplexObjectUsingIgnoreNeverAttribute()
        {
            ...
            var obj = JsonSerializerWrapper.Deserialize<ClassUsingIgnoreNeverAttribute>(json, options);
            ...
            json = JsonSerializerWrapper.Serialize(obj, options);
        ...
        [Fact]
        public void IgnoreConditionNever_WinsOver_IgnoreReadOnlyProperties()
        {
            var options = new JsonSerializerOptions { IgnoreReadOnlyProperties = true };

            // Baseline
            string json = JsonSerializerWrapper.Serialize(new ClassWithReadOnlyStringProperty("Hello"), options);
            Assert.Equal("{}", json);

            // With condition to never ignore
            json = JsonSerializerWrapper.Serialize(new ClassWithReadOnlyStringProperty_IgnoreNever("Hello"), options);
            Assert.Equal(@"{""MyString"":""Hello""}", json);

            json = JsonSerializerWrapper.Serialize(new ClassWithReadOnlyStringProperty_IgnoreNever(null), options);
            Assert.Equal(@"{""MyString"":null}", json);
        }

        [Fact]
        public void IgnoreConditionWhenWritingDefault_WinsOver_IgnoreReadOnlyProperties()
        {
            var options = new JsonSerializerOptions { IgnoreReadOnlyProperties = true };
            ...
            json = JsonSerializerWrapper.Serialize(new ClassWithReadOnlyStringProperty_IgnoreWhenWritingDefault("Hello"), options);
            Assert.Equal(@"{""MyString"":""Hello""}", json);

            json = JsonSerializerWrapper.Serialize(new ClassWithReadOnlyStringProperty_IgnoreWhenWritingDefault(null), options);
            Assert.Equal(@"{}", json);
        }

        [Fact]
        public void IgnoreConditionNever_WinsOver_IgnoreReadOnlyFields()
        {
            var options = new JsonSerializerOptions { IgnoreReadOnlyProperties = true };

            // Baseline
            string json = JsonSerializerWrapper.Serialize(new ClassWithReadOnlyStringField("Hello"), options);
            Assert.Equal("{}", json);

            // With condition to never ignore
            json = JsonSerializerWrapper.Serialize(new ClassWithReadOnlyStringField_IgnoreNever("Hello"), options);
            Assert.Equal(@"{""MyString"":""Hello""}", json);

            json = JsonSerializerWrapper.Serialize(new ClassWithReadOnlyStringField_IgnoreNever(null), options);
            Assert.Equal(@"{""MyString"":null}", json);
        }

        [Fact]
        public void IgnoreConditionWhenWritingDefault_WinsOver_IgnoreReadOnlyFields()
        {
            var options = new JsonSerializerOptions { IgnoreReadOnlyProperties = true };
            ...
            // With condition to ignore when null
            json = JsonSerializerWrapper.Serialize(new ClassWithReadOnlyStringField_IgnoreWhenWritingDefault("Hello"), options);
            Assert.Equal(@"{""MyString"":""Hello""}", json);

            json = JsonSerializerWrapper.Serialize(new ClassWithReadOnlyStringField_IgnoreWhenWritingDefault(null), options);
            Assert.Equal(@"{}", json);
        }
        ...
        [Fact]
        public void NonPublicMembersAreNotIncluded()
        {
            Assert.Equal("{}", JsonSerializerWrapper.Serialize(new ClassWithNonPublicProperties()));

            string json = @"{""MyInt"":1,""MyString"":""Hello"",""MyFloat"":2,""MyDouble"":3}";
            var obj = JsonSerializerWrapper.Deserialize<ClassWithNonPublicProperties>(json);
        ...
        [Fact]
        public void IgnoreCondition_WhenWritingDefault_Globally_Works()
        {
            // Baseline - default values written.
            string expected = @"{""MyString"":null,""MyInt"":0,""MyPoint"":{""X"":0,""Y"":0}}";
            var obj = new ClassWithProps();
            JsonTestHelper.AssertJsonEqual(expected, JsonSerializerWrapper.Serialize(obj));
        ...
        [Fact]
        public void IgnoreCondition_WhenWritingDefault_PerProperty_Works()
        {
            // Default values ignored when specified.
            Assert.Equal(@"{""MyInt"":0}", JsonSerializerWrapper.Serialize(new ClassWithPropsAndIgnoreAttributes()));
        }
        ...
        [Fact]
        public void IgnoreCondition_WhenWritingDefault_DoesNotApplyToCollections()
        {
            var list = new List<bool> { false, true };

            var options = new JsonSerializerOptions { DefaultIgnoreCondition = JsonIgnoreCondition.WhenWritingDefault };
            Assert.Equal("[false,true]", JsonSerializerWrapper.Serialize(list, options));
        }

        [Fact]
        public void IgnoreCondition_WhenWritingDefault_DoesNotApplyToDeserialization()
        {
            ...
            var options = new JsonSerializerOptions { IgnoreNullValues = true };
            ClassWithInitializedProps obj = JsonSerializerWrapper.Deserialize<ClassWithInitializedProps>(json, options);
            ...
            obj = JsonSerializerWrapper.Deserialize<ClassWithInitializedProps>(json, options);
            Assert.Null(obj.MyString);
            Assert.Equal(0, obj.MyInt);
            Assert.Equal(0, obj.MyPoint.X);
            Assert.Equal(0, obj.MyPoint.X);
        ...
        [Fact]
        public void ValueType_Properties_NotIgnoredWhen_IgnoreNullValues_Active_ClassTest()
        {
            var options = new JsonSerializerOptions { IgnoreNullValues = true };
            ...
            ClassWithValueAndReferenceTypes obj = JsonSerializerWrapper.Deserialize<ClassWithValueAndReferenceTypes>(json, options);
        ...
        [Fact]
        public void ValueType_Properties_NotIgnoredWhen_IgnoreNullValues_Active_LargeStructTest()
        {
            var options = new JsonSerializerOptions { IgnoreNullValues = true };
            ...
            LargeStructWithValueAndReferenceTypes obj = JsonSerializerWrapper.Deserialize<LargeStructWithValueAndReferenceTypes>(json, options);
        ...
        [Fact]
        public void ValueType_Properties_NotIgnoredWhen_IgnoreNullValues_Active_SmallStructTest()
        {
            var options = new JsonSerializerOptions { IgnoreNullValues = true };
            ...
            SmallStructWithValueAndReferenceTypes obj = JsonSerializerWrapper.Deserialize<SmallStructWithValueAndReferenceTypes>(json, options);
        ...
        [Fact]
        public void Ignore_WhenWritingNull_Globally()
        {
            var options = new JsonSerializerOptions
            {
...
""MyPointStruct1"":{""X"":0,""Y"":0}
            ...
            ClassWithThingsToIgnore obj = JsonSerializerWrapper.Deserialize<ClassWithThingsToIgnore>(json, options);
...
""MyPointStruct1"":{""X"":0,""Y"":0}
            ...
            JsonTestHelper.AssertJsonEqual(expectedJson, JsonSerializerWrapper.Serialize(obj, options));
        }
        ...
        [Fact]
        public void Ignore_WhenWritingNull_PerProperty()
        {
            var options = new JsonSerializerOptions
            {
                IncludeFields = true
...
""MyPointStruct1"":{""X"":0,""Y"":0}
            ...
            // All members should correspond to JSON contents, as ignore doesn't apply to deserialization.
            ClassWithThingsToIgnore_PerProperty obj = JsonSerializerWrapper.Deserialize<ClassWithThingsToIgnore_PerProperty>(json, options);
            Assert.NotNull(obj.MyPointClass2_IgnoredWhenWritingNull);
            Assert.Equal("Default", obj.MyString1_IgnoredWhenWritingNull);
            Assert.Null(obj.MyNullableBool1_IgnoredWhenWritingNull);
            Assert.Equal(0, obj.MyInt2);
...
""MyPointStruct1"":{""X"":0,""Y"":0}
        ...
        public void JsonIgnoreCondition_WhenWritingNull_OnValueType_Fail(Type type)
        {
            InvalidOperationException ex = Assert.Throws<InvalidOperationException>(() => JsonSerializerWrapper.Deserialize("", type));
            ...
            ex = Assert.Throws<InvalidOperationException>(() => JsonSerializerWrapper.Serialize(Activator.CreateInstance(type)));
            exAsStr = ex.ToString();
            Assert.Contains("JsonIgnoreCondition.WhenWritingNull", exAsStr);
            Assert.Contains("MyBadMember", exAsStr);
            Assert.Contains(type.ToString(), exAsStr);
        ...
        [Fact]
        public void JsonIgnoreCondition_WhenWritingDefault_OnValueTypeWithCustomConverter()
        {
        ...
        [Fact]
        public void JsonIgnoreCondition_ConverterCalledOnDeserialize()
        {
            // Verify converter is called.
            Assert.Throws<NotImplementedException>(() => JsonSerializerWrapper.Deserialize<MyValueTypeWithProperties>("{}"));
            ...
            Assert.Throws<NotImplementedException>(() => JsonSerializerWrapper.Deserialize<MyValueTypeWithProperties>("{}", options));
        }

        [Fact]
        public void JsonIgnoreCondition_WhenWritingNull_OnValueTypeWithCustomConverter()
        {
            string json;
            var obj = new MyClassWithValueType();
        ...
        [Fact]
        public void JsonIgnoreCondition_WhenWritingDefault_OnRootTypes()
        {
            string json;
            int i = 0;
            object obj = null;
            ...
            json = JsonSerializerWrapper.Serialize(i);
            Assert.Equal("0", json);
            ...
            json = JsonSerializerWrapper.Serialize(i, options);
            Assert.Equal("0", json);
        }
        ...
        [Fact]
        public void JsonIgnoreCondition_WhenWritingDefault_OnBoxedPrimitive()
        {
            string json;
        ...
        [Fact]
        public void JsonIgnoreCondition_WhenWritingDefault_OnInterface()
        {
