...
namespace System.Text.Json.Serialization.Tests
{
    public abstract partial class PropertyVisibilityTests
    {
        ...
        public void InitOnlyProperties_Work(Type type)
        {
            // Init-only property included by default.
            object obj = JsonSerializerWrapper.Deserialize(@"{""MyInt"":1}", type);
            Assert.Equal(1, (int)type.GetProperty("MyInt").GetValue(obj));

            // Init-only properties can be serialized.
            Assert.Equal(@"{""MyInt"":1}", JsonSerializerWrapper.Serialize(obj));
        }
        ...
        public void NonPublicInitOnlySetter_Without_JsonInclude_Fails(Type type)
        {
            ...
            Assert.Equal(@"{""MyInt"":0}", JsonSerializerWrapper.Serialize(obj));
        }
        ...
        public void NonPublicInitOnlySetter_With_JsonInclude_Works(Type type)
        {
